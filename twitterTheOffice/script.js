...
let usuarios = [
    ...
    {nombre: "@farmerDwight", foto:"img/dwight"},
    {nombre: "@rylly", foto"img/ryanKelly"},
    {nombre: "@idontcareStanley", foto"img/stanley"},
    {nombre: "theBESTboss", foto"img/michael"}
];
...
function createPost(textoUsuario){
    ...
    let avatar = document.createElement("img");
        ...
        avatar.src= "img/1 (7).jpg";

    let username = document.createElement("p");
        username.classList.add("post_username");
        username.innerText = "@prisionMike";
